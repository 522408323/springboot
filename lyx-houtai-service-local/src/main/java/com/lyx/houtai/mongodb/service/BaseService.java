...
public interface BaseService<T> {
     ...
     * remove by query
     * */
    DeleteResult removeByQuery(Query query);
     ...
     * delete by param
     * */
    DeleteResult deleteByParam(BaseParam baseParam);

    public static abstract class BaseParam {
        ...
        public abstract void buildSubCriteria(final Criteria criteria);
